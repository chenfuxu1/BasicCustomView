...
public class OnDrawLayout extends LinearLayout {
    ...
    public OnDrawLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onDraw(Canvas canvas) {
         ...
         */
        mPattern.draw(canvas); // 所以这里的绘制可能会被子 view 的绘制遮挡住，如果没有子 view 就不会
    }
